...
public static class DynamoDbAttributeMap
{
    ...
    public static Dictionary<string, AttributeValue> ToMap(FileFinding f) => new()
    {
        ...
        ["BusinessUnit"] = SNullable(f.BusinessUnit),
        ["Division"] = SNullable(f.Division),
        ["Department"] = SNullable(f.Department),
        ["Region"] = SNullable(f.Region),
        ["Country"] = SNullable(f.Country),
        ["PolicyName"] = SNullable(f.PolicyName),
        ["PolicyId"] = SNullable(f.PolicyId),
        ["FindingReason"] = SNullable(f.FindingReason),
        ["RiskLevel"] = SNullable(f.RiskLevel),
    ...
    public static FileFinding ToFileFinding(Dictionary<string, AttributeValue> m) => new()
    {
        ...
        BusinessUnit = NullableStringVal(m, "BusinessUnit"),
        Division = NullableStringVal(m, "Division"),
        Department = NullableStringVal(m, "Department"),
        Region = NullableStringVal(m, "Region"),
        Country = NullableStringVal(m, "Country"),
        PolicyName = NullableStringVal(m, "PolicyName"),
        PolicyId = NullableStringVal(m, "PolicyId"),
        FindingReason = NullableStringVal(m, "FindingReason"),
        RiskLevel = NullableStringVal(m, "RiskLevel"),
